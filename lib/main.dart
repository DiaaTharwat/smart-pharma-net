    ...
    runApp(
      MultiProvider(
        providers: [
          ...
          // =========================================================================
          ChangeNotifierProxyProvider3<AuthViewModel, PharmacyViewModel,
              MedicineViewModel, DashboardViewModel>(
            ...
            update: (context, auth, pharmacy, medicine, previous) =>
            previous!..update(auth, pharmacy, medicine),
          ),
          // =========================================================================
