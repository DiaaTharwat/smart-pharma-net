...
class AuthViewModel extends BaseViewModel {
  ...
  Future<void> restoreAdminSession() async {
    ...
    try {
      ...
      final savedAdminRefreshToken =
      prefs.getString(ApiService.adminRefreshTokenKey);
